  ...
  <div class="w3-container w3-content w3-margin-right">
    <div class="w3-card-4 w3-col s12 l8">
      <div class="w3-container w3-teal">
        ...
        <input maxlength="12" placeholder="Cedula del Solicitante" name="cedula_pac" style="width: 95%" type="text" id="cedula_pac" onkeyup="javascript:verificar_paciente()" onKeyPress="return numeros(event)" class="w3-input w3-content w3-border w3-hover-gray" type="text"></p>
      
        <div class="w3-row-padding">
          <div class="w3-half"><p>  
           <label>Nombre</label>   
           <input maxlength="30" placeholder="Nombre del Solicitante" name="nombre_pac" type="text" id="nombre_pac" required onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" class="w3-input w3-border w3-hover-gray" type="text"></p></div>
          <div class="w3-half"><p>  
           <label>Apellido</label>   
          <input maxlength="30" placeholder="Apellido del Solicitante" name="apellido_pac" type="text" id="apellido_pac" required onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" class="w3-input w3-border w3-hover-gray" type="text"></p></div>
        </div>  
        
        <div class="w3-row-padding">
          <div class="w3-half"><p>  
           <label>Fecha de Nacimiento</label>   
           <input min="1900-01-01" max="<?php echo $fecha; ?>"" type="date" name="user_date" id="user_date" onkeyup="javascript:calcularEdad()" onclick="javascript:calcularEdad()" required class="w3-input w3-border w3-hover-gray" type="text"></p></div>
          <div class="w3-half"><p>  
           <label>Edad</label>
          <input placeholder="Edad" name="edad_pac" type="text" id="edad_pac" size="24" readonly="readonly" class="w3-input w3-border w3-hover-gray" type="text"></p></div>
        </div>
        <div class="w3-row-padding">
        ...
        <div class="w3-row-padding">
          <div class="w3-half"><p>  
           ...
           <input maxlength="11" placeholder="Telefono Nº 1" name="telefono1_pac" type="text" required id="telefono1_pac" onKeyPress="return numeros(event)" class="w3-input w3-border w3-hover-gray" type="text"></p></div>
          <div class="w3-half"><p>  
           <label>Teléfono 2</label>   
          <input maxlength="11" placeholder="Telefono Nº 2" name="telefono2_pac" type="text" id="telefono2_pac" onKeyPress="return numeros(event)" class="w3-input w3-border w3-hover-gray" type="text"></p></div>
        </div>
        <div class="w3-row-padding">
          <div class="w3-row-padding">          
          <div class="w3-half"><p>
        ...
        <input maxlength="80" placeholder="Sector de Residencia" name="sector_pac" id="sector_pac" style="width: 95%" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"  type="text" class="w3-input w3-border w3-hover-gray w3-content" ></p>      
    ...
    <div class="w3-card-4 w3-col s12 l8">
      ...
      <div class="w3-row-padding">
          <div class="w3-half"><p>  
           ...
           <input maxlength="12" placeholder="Cedula del Representante" name="cedula_rep" type="text" id="cedula_rep" onKeyPress="return numeros(event)" required class="w3-input w3-border w3-hover-gray"></p></div>
          <div class="w3-half"><p>  
           <label>Teléfono</label>   
          <input maxlength="11" placeholder="Telefono" name="telefono_rep" type="text" id="telefono_rep" onKeyPress="return numeros(event)" required class="w3-input w3-border w3-hover-gray"></p></div>
      </div>  
      <div class="w3-row-padding">
          <div class="w3-half"><p>  
           <label>Nombre</label>   
           <input maxlength="30" placeholder="Nombre del Representante" name="nombre_rep" type="text" id="nombre_rep" required onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" class="w3-input w3-border w3-hover-gray"></p></div>
          <div class="w3-half"><p>  
           <label>Apellido</label>   
          <input maxlength="30" name="apellido_rep" placeholder="Apellido del Representante" type="text" id="apellido_rep" required onKeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" class="w3-input w3-border w3-hover-gray"></p></div>
      </div>  
        <br>
