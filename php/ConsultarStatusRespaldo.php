...
<!--HEADER-->
  ...
  if ($_POST) { //seleccion ObservacionesStatus status
    ...
    echo "Id SOlici: ".$IdSolicitud = $_POST['seleccionstatus'];
    echo "<br>";
    ...
    //Consulta de los datos a la Tabla Status 
    $Tstatus = $conexion -> prepare ("INSERT INTO status (observaciones_status, fecha_status, id_defsta1, id_solici1, id_login1, nombre_login, asignado, id_redsal2, requerimientosaprobados, costo) 
                VALUES (:observaciones_status, :fecha_status, :id_defsta1, :id_solici1, :id_login1, :nombre_login, :asignado, :id_redsal2, :requerimientosaprobados, :costo)");
  ...
  <table class="w3-table w3-bordered w3-border w3-card-4">
    ...
    $ConsultaStatus = $conexion -> prepare("SELECT id_status, id_defsta1, id_solici1, observaciones_status, fecha_status, nombre_redsal, nombre_defsta, nombre_login, asignado, id_redsal2, requerimientosaprobados
                                            ...
                                            WHERE id_solici1 = '$seleccion'  and activo = 'activo'
    ...
    foreach ($ResultadoStatus as $VerStatus)      
      { $ContadorStatus=0; $compara = $VerStatus["id_defsta1"];              
        ...
        <tr>            
          ...
          <td colspan="" width="100">  <strong>Fecha:</strong><br><?php echo $VerStatus["fecha_status"]; ?> </td>            
        </tr>
        <?php 
      ...
      <tr>      
        <td class="w3-center">
            ...
            <div id="fechaStatusSec">
              <input min="2022-01-01" max="<?php echo $hoy; ?>" style="width:20%" required = "required" name="fechaStatus" type="date" id="fechaStatus" class="w3-input w3-border w3-half w3-margin-left w3-hover-gray">            
            </div>            
            </td>
      </tr>      
      <tr>
